...
xsltApplyStylesheetInternal(xsltStylesheetPtr style, xmlDocPtr doc,
                            ...
                            void (*_PA_YieldAbsolute)(void), xsltTransformContextPtr userCtxt)
{
    xmlDocPtr res = NULL;
...
xsltProfileStylesheet(xsltStylesheetPtr style, xmlDocPtr doc,
                      const char **params, void (*_PA_YieldAbsolute)(void))
{
    xmlDocPtr res;

    res = xsltApplyStylesheetInternal(style, doc, params, NULL, _PA_YieldAbsolute, NULL);
    return (res);
}
		  ...
		  void (*_PA_YieldAbsolute)(void), xsltTransformContextPtr userCtxt)
{
    ...
    tmp = xsltApplyStylesheetInternal(style, doc, params, output, _PA_YieldAbsolute,
	                              userCtxt);
    if (tmp == NULL) {
	xsltTransformError(NULL, NULL, (xmlNodePtr) doc,
